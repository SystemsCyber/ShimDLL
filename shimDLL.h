...
typedef short  (WINAPI *GETHARDWARESTATUS)(short, char *, short, short);
typedef short  (WINAPI *GETHARDWARESTATUSEX)(short, char *, short, short);
typedef short  (WINAPI *GETERRORMESSAGE)(short, char *);
